...
export const BottomNav: FC<Props> = ({ current, onChange, onAdd, followingCount, savedCount }) => {
  return (
    <div className="absolute bottom-0 left-0 right-0 h-14 bg-black border-t border-divider flex items-center justify-around z-30">
      ...
      <button
        onClick={onAdd}
        className="flex flex-col items-center gap-0.5 px-3 py-1.5 tap-active text-text-dim"
        aria-label="Quick Add / Request Course"
      >
